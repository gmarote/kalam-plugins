...
trazabilidad (archivo, hoja, fila de origen), jerarquía con nombre (división
—edificio/bloque, cuando aplica—, capítulo, subcapítulo, sección y ruta
completa), código, una columna principal con el
